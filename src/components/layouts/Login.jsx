...
export default function Login()
{
  ...
  return(
    // Section Login
    <section className='relative w-full h-screen bg-zinc-900/90'>
      <img src={BackgroundLogin} alt="Background Login" className='absolute w-full h-full object-cover mix-blend-overlay' />
      ...
      <div className='flex justify-center items-center h-full'>
        <form className='max-w-[400px] w-full mx-auto bg-white p-8 rounded-md shadow-md shadow-green-600/40' onSubmit={handleSubmit}>
          ...
          <button className='w-full py-3 mt-4 bg-green-600 hover:bg-green-500 relative text-white'>
            Sign In
          </button>
        </form>
      </div>
